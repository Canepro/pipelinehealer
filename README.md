...
- Release-discipline follow-up patch: `demo:proof` keeps flag parsing intact when `--repo` is missing a value, `aoai:check` returns concise request/JSON failures, and the protected-branch runbook now makes post-review tagging mandatory.
