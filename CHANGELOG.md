...
- Landing page polish: scroll entrance animations (framer-motion), animated capability counters strip, multi-agent pipeline architecture diagram, and mobile-responsive layout improvements.
