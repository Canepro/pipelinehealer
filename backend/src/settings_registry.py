...
RUNTIME_SETTING_SPECS: tuple[SettingSpec, ...] = (
    ...
    SettingSpec("agent_handoff_local_codex_enabled", "AGENT_HANDOFF_LOCAL_CODEX_ENABLED", "boolean", False, False, False, "handoff", "runtime", False),
    SettingSpec("agent_handoff_local_codex_open_pr", "AGENT_HANDOFF_LOCAL_CODEX_OPEN_PR", "boolean", False, False, False, "handoff", "runtime", True),
    SettingSpec("agent_handoff_local_codex_timeout_ms", "AGENT_HANDOFF_LOCAL_CODEX_TIMEOUT_MS", "integer", False, False, False, "handoff", "runtime", 600000),
    SettingSpec("agent_handoff_local_codex_workspace_root", "AGENT_HANDOFF_LOCAL_CODEX_WORKSPACE_ROOT", "string", False, False, False, "handoff", "runtime", ""),
    SettingSpec("agent_handoff_local_max_concurrent", "AGENT_HANDOFF_LOCAL_MAX_CONCURRENT", "integer", False, False, False, "handoff", "runtime", 1),
    SettingSpec("agent_handoff_auto_local", "AGENT_HANDOFF_AUTO_LOCAL", "boolean", False, False, False, "handoff", "runtime", False),
