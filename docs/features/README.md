...
1. New user setup: `06-operations-and-deploy.md`
2. Sign-in and access controls: `01-auth-and-access.md`
3. Core CI remediation flow: `02-diagnosis-and-remediation.md`
